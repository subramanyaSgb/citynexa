...
export function TestimonialActions({
  ...
  function handleToggle() {
    startTransition(async () => {
      await toggleTestimonialActive(testimonialId);
    });
  }
  ...
  return (
    <div className="flex items-center justify-end gap-2">
      <Switch
        ...
        disabled={isPending}
        aria-label={`Toggle ${testimonialName} active status`}
      />
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          <DropdownMenuItem asChild>
            <Link href={`/admin/testimonials/${testimonialId}/edit`}>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <strong>{testimonialName}</strong>? This action cannot be undone.
            </DialogDescription>
          </DialogHeader>
